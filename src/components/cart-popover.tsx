...
const CartPopover = () => {
  ...
  return (
    <Popover>
      ...
      <PopoverContent align="end" className="p-0 bg-grey-500 border-grey-800 w-screen max-w-96 shadow-2xl">
        <div className="flex min-h-[420px] flex-col">
          ...
          <div className="flex max-h-[400px] grow flex-col overflow-y-auto px-4">
            {cart.map((item) => (
              item.identifier &&
              <div key={`${item.collection}-${item.identifier}`} className="group rounded-lg hover:bg-grey-700">
